const CRUD = Object.freeze({
	...
	editarNotas : "UPDATE notas SET userid = :userid, status = :status, descripcion_nota = :descripcion_nota, fecha_entrega = :fecha_entrega, id_cliente = :id_cliente WHERE id_nota = :id_nota;",
